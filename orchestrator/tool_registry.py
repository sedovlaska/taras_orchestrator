...
TOOLS = {
    ...
    "code.list_workspace_files": ToolSpec(
        name="list_workspace_files",
        agent="code",
        description="List project-scoped workspace files.",
        risk=ToolRisk.LOW,
        args={"limit": "Maximum number of files to return."},
        touches_filesystem=True,
    ),
    "code.read_workspace_file": ToolSpec(
        name="read_workspace_file",
        agent="code",
        description="Read one project-scoped text file with size and binary safeguards.",
        risk=ToolRisk.LOW,
        args={"path": "Project-relative file path to read."},
        touches_filesystem=True,
    ),
    "code.search_workspace": ToolSpec(
        name="search_workspace",
        agent="code",
        description="Search project-scoped text files for a query.",
        risk=ToolRisk.LOW,
        args={"query": "Text to search for.", "limit": "Maximum result count."},
        touches_filesystem=True,
    ),
